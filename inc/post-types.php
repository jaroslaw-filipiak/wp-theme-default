...
function media_post_type() {
	...
	$labels = array(
		...
		'menu_name'             => __( 'Wpisy(media)', 'text_domain' ),
...
function blog_post_type() {
	...
	$labels = array(
		...
		'menu_name'             => __( 'Wpisy(blog)', 'text_domain' ),
...
function podcasts_post_type() {
	...
	$labels = array(
		...
		'menu_name'             => __( 'Podcasty', 'text_domain' ),
...
function testimonials_post_type() {
	...
	$labels = array(
		...
		'singular_name'         => _x( 'Opinie', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Opinie', 'text_domain' ),
		'name_admin_bar'        => __( 'Opinie', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'attributes'            => __( 'Item Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'All Items', 'text_domain' ),
